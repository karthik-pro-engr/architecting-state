package com.karthik.pro.engr.viewmodelssh.ui.viewmodel
...
class BalancedEnergyViewModel(private val ss: SavedStateHandle) : ViewModel() {
    ...
    private fun persist() {
        ss[KEY_HOUSES] = houseTypes.toTypedArray()
