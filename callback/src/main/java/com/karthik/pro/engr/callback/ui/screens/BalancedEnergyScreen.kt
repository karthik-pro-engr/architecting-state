package com.karthik.pro.engr.callback.ui.screens
...
import com.karthik.pro.engr.callback.EnergyListener
...
fun BalancedEnergyScreen(
    ...
    houseTypes: SnapshotStateList<String>,
    ...
    Column(
        ...
        Row(
            ...
            Button(
                onClick = {
                    energyListener.addHouseType(input)
                    input = ""
                },
...
private fun BalancedEnergyScreenPreview() {
    BalancedEnergyScreen(
        energyListener = object : EnergyListener {
        ...
        houseTypes = remember { mutableStateListOf<String>() },
        stretchResult = null,
        errorMessage = ""
    )
}